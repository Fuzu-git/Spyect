...
public class MoveCube : MonoBehaviour
{
    ...
    public void SelectViableDestinations()
    {
        ...
        else
        {
            ...
            //je calcule deux points interm�daires pour dessiner mes deux droites de support
            ...
            //res est le point en diagonal selectionn�
    ...
    public bool TestAndGo(Vector3 target)
    {
        ...
        if (testPath.corners.Length > 2) //y'a un obstacle il faut calculer de nouveaux point interm�diaire
        {
            return false;
        }
